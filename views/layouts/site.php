...
<!-- ═══════════ NAV ═══════════ -->
<nav id="mainNav">
  <a href="<?=Url::to(['site/main'])?>" class="nav-logo">Dev<span>Start</span></a>
  <ul class="nav-links">
...
<footer>
  <div class="footer-inner">
    <div class="footer-brand">
      <div class="footer-logo">Dev<span>Start</span></div>
      <div class="footer-tagline">Sun'iy intellekt asosida dasturlash o'rgatuvchi zamonaviy ta'lim platformasi.</div>
  ...
  <div class="footer-bottom">
    <div class="footer-copy">© 2025 DevStart. Barcha huquqlar himoyalangan.</div>
