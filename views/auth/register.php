...
<?php
    $form = ActiveForm::begin([
	    ...
	    'fieldConfig' => [
	        'options' => ['class' => 'modal-form-group'], // Har bir field uchun wrapper
	        'labelOptions' => ['class' => 'modal-label'],  // Label klassi
	        'inputOptions' => ['class' => 'modal-input'],  // Input klassi
	        'errorOptions' => ['class' => 'text-danger'], // Yuqorida yozgan error-badge stilimiz uchun
	    ],
	]);
?>
...
<?php if (Yii::$app->session->hasFlash("google-register-errors")): ?>
    <script type="text/javascript">
        // Flash ma'lumotlarini JS ga xavfsiz o'tkazish
    ...
    $this->registerJs(<<<JS
        ...
        if (typeof google_errors !== 'undefined') {
            Object.values(google_errors).flat().forEach(msg => {
                // Toastify yuklanganini tekshirib keyin chaqiramiz
