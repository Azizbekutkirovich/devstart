...
<section class="hero" id="home">
  ...
  <div class="hero-content">
    ...
    <p class="hero-subtitle">Sun'iy intellekt texnologiyalari asosida dasturlashni o'qitish jarayonini avtomatlashtiruvchi va individuallashtirib beruvchi zamonaviy ta'lim platformasi.</p>
    <div class="hero-cta">
...
<div class="stats-strip">
  <div class="stat-card reveal" style="animation-delay:.1s"><div class="stat-icon">⚡</div><div class="stat-tag">// stat.01</div><div class="stat-number">100%</div><div class="stat-label">Avtomatlashtirilgan o'quv jarayoni</div></div>
  <div class="stat-card reveal" style="animation-delay:.2s"><div class="stat-icon">🤖</div><div class="stat-tag">// stat.02</div><div class="stat-number">AI</div><div class="stat-label">Individual ta'lim modeli boshqaruvi</div></div>
  <div class="stat-card reveal" style="animation-delay:.3s"><div class="stat-icon">👥</div><div class="stat-tag">// stat.03</div><div class="stat-number">3+</div><div class="stat-label">Foydalanuvchi toifasi va guruh</div></div>
  <div class="stat-card reveal" style="animation-delay:.4s"><div class="stat-icon">∞</div><div class="stat-tag">// stat.04</div><div class="stat-number">∞</div><div class="stat-label">Moslashuvchan kurs va yo'nalish</div></div>
</div>
...
<section class="how-section" id="how">
  <div class="section-inner">
    ...
    <p class="section-desc reveal">Uch bosqichli aqlli ta'lim zanjiri — platformaga kirgandan boshlab to malaka oshirishgacha to'liq qo'llab-quvvatlaydi.</p>
    <div class="how-steps">
      <div class="how-card reveal" style="animation-delay:.1s">
        ...
        <div class="how-card-body"><div class="how-card-title">Daraja aniqlash</div><div class="how-card-text">AI foydalanuvchi bilimini tezkor test orqali o'lchab, unga mos individual o'quv yo'li tuzadi.</div></div>
      </div>
      <div class="how-card reveal" style="animation-delay:.2s">
        ...
        <div class="how-card-body"><div class="how-card-title">AI bilan o'rganish</div><div class="how-card-text">Interaktiv darslar, kod misollar va AI mentor tushuntirishlari orqali mavzu chuqur o'zlashtiriladi.</div></div>
      </div>
      <div class="how-card reveal" style="animation-delay:.3s">
        ...
        <div class="how-card-body"><div class="how-card-title">Baholash & O'sish</div><div class="how-card-text">Testlar bajarilgach natijalar tahlil qilinib xatolar aniqlanadi. Tavsiyalar asosida kurs dinamik o'zgaradi.</div></div>
      </div>
    </div>
  </div>
</section>
      ...
      <div class="mentor-card reveal">
        <div class="mentor-card-banner">
          <div class="mentor-avatar-wrap">
            ...
            <!-- <div style="width:100%;height:100%;background:linear-gradient(135deg,#0a2040,#0d4070);display:flex;align-items:center;justify-content:center;font-size:2.8rem;">🤖</div> -->
          </div>
        </div>
...
<section class="courses-section" id="courses">
  <div class="section-inner">
    ...
    <p class="section-desc reveal">Har bir kurs AI tomonidan moslashtiriladi. Boshlang'ichdan professionalga qadar barcha darajalar uchun individual o'quv yo'li taqdim etiladi.</p>
